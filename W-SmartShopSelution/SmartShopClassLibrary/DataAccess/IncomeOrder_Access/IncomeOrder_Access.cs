...
namespace Library
{
    public static class IncomeOrder_Access
    {
        /// <summary>
        ...
        public static List<IncomeOrderModel> GetIncomeOrders(string db)
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnVal(db)))
            {
                ...
                foreach (IncomeOrderModel incomeOrder in incomeOrders)
                {
                    ...
                    incomeOrder.Products = connection.Query<IncomeOrderProductModel>("dbo.spIncomeOrder_GetIncomeOrderProductByIncomeOrderId", p, commandType: CommandType.StoredProcedure).ToList();
